...
using TOOL_VIETSUB.Controllers;
...
public sealed class ProjectApiIntegrationTests
{
    ...
    private static ToolVietSubDbContext CreateDatabase()
    {
        var options = new DbContextOptionsBuilder<ToolVietSubDbContext>()
            .UseSqlServer(ConnectionString)
            .EnableDetailedErrors()
            .Options;
        return new ToolVietSubDbContext(options);
    }
}
