...
Ứng dụng hỗ trợ ba lựa chọn dịch:
...
2. Mỗi nhóm tối đa 12 cue cần dịch nhận thêm ba cue trước/sau làm ngữ cảnh.
...
1. Chọn Local, OpenAI hoặc Gemini.
...
- Chạy đánh giá mù OpenAI, Gemini và local trên cùng dữ liệu.
