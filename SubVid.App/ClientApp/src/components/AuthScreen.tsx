    ...
    <div className="auth-shell">
      <header className="auth-title-bar">
        <div className="title-brand">
          <img className="app-mark" src="/subvid-icon.png" alt="" aria-hidden="true" />
          <strong>SubVid</strong>
      ...
      <main className="auth-stage">
        ...
        <section className="auth-intro" aria-label="Giới thiệu SubVid">
        ...
        <section className={`auth-card ${challenge ? 'auth-card--otp' : ''}`} aria-labelledby="auth-title">
          ...
          <div className="auth-card__top">
            ...
            <div className="auth-card__heading">
              ...
              <h2 id="auth-title">{challenge ? 'Nhập mã OTP' : mode === 'login' ? 'Đăng nhập SubVid' : 'Tạo tài khoản mới'}</h2>
